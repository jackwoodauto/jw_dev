...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if (new_job_name == '') {
                ...
                $.ajax({
                    ...
                    success: function(html) {
                        ...
                        var ob = $("#job_selected");
                        ob.prepend("<option selected='selected' value='" + incoming_data.NewJobID + "'>" + incoming_data.ReturnJob + "</option>");
        ...
        function JobSelected() {
            ...
            $.ajax({
                ...
                success: function(newdata) {
                  ...
                  //var job_status_area2 = $('#job_status_area');
                    job_status_area.html(returnedHTML).fadeIn(1500);
                  //var myJSON = JSON.stringify(returnedHTML2);
                  //job_status_area2.html(myJSON).fadeIn(1500);
        ...
        function DocSelected() {
            ...
            $.ajax({
                ...
                success: function(newdata) {
                    ...
                    var drag_map = $('#drag_map');
                    var returnedHTML = return_data['html4'];
                    drag_map.html(returnedHTML).fadeIn(1500);
        ...
        $("#submitNewColumn").click(function(){
            ...
            var dropdown = $('#col_type_selected');
            var col_type_selected = dropdown.val();
            ...
            var dropdown = $('#doc_select');
            var selected_wholesaler_id = dropdown.val();
            var info = [selected_wholesaler_id,dataString,col_type_selected] ;
            //var info[0] = dropdown;
