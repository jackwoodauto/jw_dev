		...
		<META HTTP-EQUIV="Content-Language" Content="en">
			...
			<script type="text/javascript">
				...
				$("#submit123").click(function(){
					var new_job_name = document.getElementById("new_job_name").value;
					...
					if (new_job_name == '') {
						...
						$.ajax({
							...
							//	alert(obj);
							//	alert(obj.ErrorStatus);
							//	alert(obj.ReturnJob);


										var x = document.getElementById("job_selected");
										var option = document.createElement("option");
										option.text = obj.ReturnJob;
										x.add(option, x[0]);
										x.add(value);
								//	$(option).attr('value') == 4;
									//	$( "job_selected" ).append(<option value= obj.Return Jobselected="selected";> obj.ReturnJob</option>");
								...
								<div class="col-md-12">
									<div class= "input_group">
										...
										<div class="col-md-6"  style="margin-left: 0px !important; padding: 0px 0px 0px 0px;">
											<button id="submit123" class="input-group-btn btn btn-primary btn-file submit123" style="width: 120px; padding: 0px 0px 0px 0px !important; display:inline; margin-left: 0px;" type="submit123">New Job<i class="icon-plus"></i></button>
										</div>
						...
						<div class="content-wrap custom-top">
							<div class="container clearfix">
								<div class="col-md-12" style="margin-right:0px !important; padding: 0px 0px 0px 0px !important; display: inline; padding-right: 0px !important;">
									...
									<select id="job_selected" name="job_selected">
										<?php
										$servername = "localhost";
										$dbname = "ejdev_db";
										$username = "ejdev_db";
