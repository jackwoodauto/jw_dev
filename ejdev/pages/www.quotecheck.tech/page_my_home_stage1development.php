                                ...
                                <div class="col-xs-12">
                                    <div class= "input_group">
                                        ...
                                        <div class="col-sm-6 col-xs-2" style="margin-left: 0px !important; width:20%;padding: 0px 0px 0px 0px;">
                                            <button id="submitNewJob" class="input-group-btn btn btn-primary btn-file submitNewJob" style="width: 100%; max-width:120px; padding: 0px 0px 0px 0px !important; margin-left: 0px;" type="submitNewJob"><span class="hidden-xs hidden-sm ">New Job</span><i class="icon-plus"></i></button>
                                            <!-- <button id="submitNewJob" class="input-group-btn btn btn-primary btn-file submitNewJob" style="width: 120px; padding: 0px 0px 0px 0px !important; display:inline!important; margin-left: 0px;" type="submitNewJob">New Job<i class="icon-plus"></i></button> -->
                                            <!-- <div class="col-xs-6"  style="margin-left: 0px !important; padding: 0px 0px 0px 0px;">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form id="qc_upload" method="post" action="pr_upload" enctype="multipart/form-data">
                                    ...
                                    <div class="content-wrap custxxxom-top">
                                        <div class="container clearfix">

                                            <div style="margin-top: 150px; margin-bottom: 75px" ></div>
                                            <h4 style="margin-top: 50px; margin-bottom: 0px">Upload a New File</h4>
