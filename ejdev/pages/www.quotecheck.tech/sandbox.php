...
<body class="stretched" data-loader-timeout="3000">
    ...
    <div   class="clearfix">
        ...
        <form id="qc_upload" method="post" action="example_document_upload" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="content-wrap">
                            <h4>Select an Example Document</h4>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="box-wrapper col-md-6" style="margin-left:0px !important; padding: -20px 0px 0px 0px !important; display: inline; padding-left: 0px !important; margin-right:0px;">
                                        ...
                                        <div class="input-group ">
                                            ...
                                            <div class="input-group-btn">
                                                <button tabindex="500" title="Clear selected files" class="btn btn-default fileinput-remove fileinput-remove-button" type="button"><i class="icon-trash"></i> <span class="hidden-xs">Remove</span></button>
                                                <button tabindex="500" title="Abort ongoing upload" class="btn btn-default hide fileinput-cancel fileinput-cancel-button" type="button"><i class="icon-ban-circle"></i> <span class="hidden-xs">Cancel</span></button>

                                                <div tabindex="500" class="btn btn-primary btn-file"><i class="icon-folder-open"></i> <span class="hidden-xs">Browse …</span><input name="example_template[]" class="file-input-qc" id="input-quote" style="color:#fff;" type="file"></div>
                                            </div>
                                        </div></div>
                                    </div>
                                </div>
                                        ...
                                        <div class="promo promo-center"> <!-- provides a bit of spacing-->
                                            <div class="box-wrapper">
                                                <div class="bottoxxxmmargin">
                                                    <button name="file-select-submit" class="button button-3d button-green nomargin upload-files-qc" style="display: none;" value="upload">Upload File</button>
                                                    <div class="preloader" style="display: none;"><img src="imgs\quotecheck\preloader.gif"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
