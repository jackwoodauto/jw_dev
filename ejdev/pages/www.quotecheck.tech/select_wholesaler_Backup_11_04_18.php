...
<?php
    ...
    $sql = "SELECT wholesaler_name FROM qc_pr_wholesaler_names WHERE fk_user_id = ? AND id = ?";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $sql = "SELECT fk_doc_id , id FROM qc_pr_wholesaler_doc WHERE fk_doc_id = ?";
  ...
  //               $idcheck = $row["id"];
      ...
      ?>
    <option value="<?php echo "$idcheck" ?>">Wholesaler doc ID:<?php echo "$idcheck"?></option>
      <?php
    }
